@pushOnce('js')
    ...
    <script type="text/javascript">
        ...
        //     const modalElement = document.getElementById('kelainanModal');
        ...
        $(document).ready(function () {
            $('#data').DataTable({
                ...
                columns: [
                    ...
                    { data: 'desc_kelainan', name: 'desc_kelainan' },
                    {
                        data: 'action',
                        name: 'action',
                        orderable: false,
        ...
        $('#saveKelainan').on('submit', function(e) {
            e.preventDefault();

            $.ajax({
                url: '{{ route("kelainan/store") }}',
                type: 'POST',
                data: $(this).serialize(),
