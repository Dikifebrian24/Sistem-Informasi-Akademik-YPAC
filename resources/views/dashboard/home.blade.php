                            ...
                            <div class="form-inline">
                                <div class="form-group">
                                    <input class="inp-val form-control m-r-10" id="input_copy" type="text" value=""
                                           readonly="readonly">
                                    <button class="btn btn-primary notification" onclick="myFunction()">Copy text
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-8">{{ $siswa->nm_siswa }}</div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-sm-4 font-weight-bold">NISN</div>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-8">{{ $siswa->tmpt_lahir }}, {{ $siswa->tgl_lahir }}</div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-sm-4 font-weight-bold">Jenis Kelamin</div>
                                    <div class="col-sm-8">{{ $siswa->jenkel }}</div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-sm-4 font-weight-bold">Alamat</div>
                                    <div class="col-sm-8">{{ $siswa->almt_rumah }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
