...
@section('content')
    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-6">
                        <h3>Laporan Progress Siswa</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/">Home</a></li>
                            <li class="breadcrumb-item">Laporan Progress Siswa</li>
                        </ol>
                    </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="needs-validation" id="f_filter_kelas" novalidate>
                                        @csrf
                                        <div class="row g-3">
                                            {{-- Mata Pelajaran --}}
                                            <div class="col-md-8">
    ...
    @include('dashboard.akademik.progress.modal')
